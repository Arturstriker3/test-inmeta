...
<template>
    <div className="w-screen h-screen overflow-hidden">
      <div v-if="shouldShowNavbar">
        <div className='w-screen py-6 px-5 lg:px-16 bg-[#154EC1] flex justify-between text-white items-center'>
          ...
          <button className='space-y-1 group md:hidden z-50'>
            ...
            <ul className='bg-[#154EC1] w-screen h-screen pb-10 absolute -top-full group-focus:top-0 right-0 duration-500 flex flex-col space-y-3 justify-start font-semibold text-lg'>
              ...
              <li  v-if="userAuth.GetIsAuth" className='flex justify-center w-full py-4 hover:bg-slate-300' @click="handleLogout">
                <VaIcon
                    :name="'logout'"
                    color="#ffffff"
                    :size="30"
